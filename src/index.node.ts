 ...
 *
 * Runtime: Node.js (>=20) + the 'ws' package. Used as a local fallback for
 * developers who don't have Deno installed. The canonical deployed runtime
 * is src/index.ts (Deno Deploy).
 */
